...
anyway! :) </p>''',
    ...
    'subtitle_wordlist': 'Kann ich die auch herunterladen?',
    'text_wordlist': '''<p>Die Wortlisten können hier heruntergeladen werden:</p>''',
    'reference_wordlist': '''<p>Die Wortlisten stammen von dem 
...
unter <a href="https://creativecommons.org/licenses/by-nc/4.0/">CC-BY-NC</a>
Lizenz verfügbar. Wörter, die andere Zeichen als Buchstaben enthalten und sehr
kurze Wörter wurden herausgefiltert. Außerdem wurden alle Wörter in
Kleinschreibung umgewandelt..</p>
